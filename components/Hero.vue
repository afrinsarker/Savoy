<template>
  <div>
    ...
    <div class="carousel-inner relative overflow-hidden w-full">
      ...
      <!---banner---->
        <div class="bg-cover bg-no-repeat py-16 relative pt-16 pb-32 flex content-center items-center justify-center"  style="
      ...
      <!---banner---->
        ...
        <div class="carousel-item absolute opacity-0" style="height:100%;">
          <!---banner---->
        <div class="bg-cover bg-no-repeat py-16 relative pt-16 pb-32 flex content-center items-center justify-center"  style="
                background-image: url('https://savoy-webstack.netdna-ssl.com/wp-content/uploads/2015/08/slider-pendant-lighting.jpg');">
        ...
        <div class="carousel-item absolute opacity-0" style="height:100%">
          <!---banner---->
        <div class="bg-cover bg-no-repeat py-16 relative pt-16 pb-32 flex content-center items-center justify-center"
